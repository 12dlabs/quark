...
declare namespace AliHub.Common {
    ...
    class VisualControl {
        ...
        /**
          ...
          */
        add_styleRef(value: string | string[]): string[];
        /**
          * Removes class.
          * @param value  A list of class to remove.
          */
        remove_styleRef(value: string | string[]): string[];
        /**
          * Modifies class.
          * @param adding  A list of class to add.
          * @param removing  A list of class to remove.
          */
        modify_styleRef(adding: string[], removing: string[]): string[];
        /**
          * Modifies class.
          * @param adding  A list of class to add.
          * @param removing  A list of class to remove.
          */
        styleRef(adding?: string[], removing?: string[], ...childId: string[]): string[];
        /**
          * Adds class.
          * @param value  A list of class to add.
          */
        ...
        /**
          ...
          * @param key  Style property value.
          */
        styleProp(key: string, value: string): any;
        /**
          * Gets parent control.
          */
        ...
        /**
          ...
          */
        loadOptions(value: VisualControlOptionsContract<VisualControl> | boolean): any;
        /**
          * Appends an element as child.
          * @param child  An element to add; or tag name of element to add.
          */
        appendElement(child: HTMLElement | string, idSuffix?: string): HTMLElement;
        /**
        ...
        /**
          ...
          */
        getSize(...childId: string[]): PlaneCoordinate;
        /**
          * Gets the position of the specific element in document.
          */
        getPosition(...childId: string[]): Common.PlaneCoordinate;
        /**
          * Gets the position of the mouse in specific element or document.
          */
        getMousePosition(...childId: string[]): Common.PlaneCoordinate;
        /**
          * Clears the control.
          */
        clear(): void;
        ...
        /**
          ...
          */
        requestFullScreen(...childId: string[]): void;
        /**
    ...
    class Text {
        ...
        /**
          ...
          */
        static format(template: string, parameters?: any, uriComponent?: boolean, preBag?: string[] | Func<string[]>): string;
        /**
          * Trims a string.
        ...
        /**
           ...
           */
        static base64encode(str: any): any;
        /**
         * Decodes from base64.
          * @param str The string to convert.
          */
        ...
        /**
          ...
          * @param str The string to convert.
          */
        static utf16to8(str: any): any;
        /**
          * Converts UTF-8 to UTF-16.
          * @param str The string to convert.
          */
        static utf8to16(str: any): any;
    }
    /**
    ...
    class Reflection {
        ...
        /**
          ...
          */
        static getId<T extends IdentifiedContract>(model: string | T, h?: Action1<T>): string;
        /**
          * Unwraps object.
    ...
    class BindingControl<T> extends VisualControl implements BindingContainerContract<T> {
        ...
        /**
          ...
          */
        setViewModelFromWeb(subject: string, key: string | Web.BaseDataPackageResolver<T>, parameters?: any): TaskContract<Web.ResponseContract<T>>;
        /**
    ...
    class ActivityControl extends VisualControl {
        ...
        /**
          ...
          */
        add(control?: Func1<string, VisualControl>, model?: any, h?: Action1<VisualControl>): ControlInfoContract;
        /**
          * Gets item info.
    ...
    /**
      * Rejects deferred.
      */
    function rejectDeferred(deferred: any, message: string, info?: any, inner?: any): void;
    /**
    ...
    /**
      ...
      * @param options  The options to load.
      */
    function fillControl<T extends Common.VisualControl>(element: HTMLElement | string, type?: string | typeof Common.VisualControl, options?: VisualControlOptionsContract<T> | boolean): T;
    /**
    ...
    /**
      ...
      */
    function createControl(id: string, control?: typeof VisualControl, parent?: VisualControl, options?: VisualControlOptionsContract<VisualControl> | boolean): VisualControl;
    /**
      ...
      */
    function visualControl<T>(idSuffix: string, parent?: VisualControl, options?: VisualControlOptionsContract<VisualControl>): VisualControl;
    /**
      ...
      * @param options  The initializition options.
      */
    function bindingControl<T>(idSuffix: string, parent?: VisualControl, options?: BindingControlOptionsContract<T>): BindingControl<T>;
    /**
      ...
      * @param options  The initializition options.
      */
    function activityControl(idSuffix: string, parent?: VisualControl, options?: ActivityControlOptionsContract): ActivityControl;
    /**
      * Extends a class.
...
declare namespace AliHub.Collection {
    ...
    class BindingControl<T> extends Common.VisualControl implements Common.BindingContainerContract<T[]> {
        ...
        /**
          ...
          * @param key  The key of data resolver.
          */
        setViewModelFromWeb(subject: string, key: string | Web.BaseDataPackageResolver<T[]>, parameters?: any): Common.TaskContract<Web.ResponseContract<T[]>>;
        /**
          * Subscribe view model changed.
          * @param h  Callback during value has been changed.
          * @param target  The "this" target of h callback.
    ...
    class SwitchControl extends Common.VisualControl {
        ...
        /**
          ...
          */
        add(control?: Common.Func1<string, Common.VisualControl>, model?: any, options?: SwitchItemOptionsContract): Common.VisualControl;
    ...
    class EventHandlers<T> {
        ...
        /**
          ...
          */
        add(h: (ev: T) => void, target?: any, disposableList?: DisposableArray, args?: any): Common.DisposableContract;
        /**
          * Raises this event.
    ...
    /**
      ...
      */
    function toArray<T>(value: T | T[], emptyForNull?: boolean): T[];
    /**
      ...
      * @param emptyForNull  A value indicating whether need return an empty array if given item is null.
      */
    function toStringArray(value: string | string[], emptyForNull?: boolean): string[];
    /**
    ...
    /**
      ...
      * @param nullCheck  A value indicating whether add null in the one to add.
      */
    function pushRange(list: any[], adding: any[], nullCheck?: boolean): any[];
    /**
      ...
      */
    function remove(list: any[], removing: any[], changeRaw?: boolean, compare?: Common.Func2<any, any, boolean>): any[];
    /**
    ...
    /**
      ...
      * @param options  The initializition options.
      */
    function bindingControl<T>(idSuffix: string, parent?: Common.VisualControl, options?: BindingControlOptionsContract<T>): BindingControl<T>;
    /**
      ...
      * @param options  The initializition options.
      */
    function listControl<T>(idSuffix: string, parent?: Common.VisualControl, options?: ListControlOptionsContract<T>): ListControl<T>;
    /**
      ...
      * @param options  The initializition options.
      */
    function pagingControl(idSuffix: string, parent?: Common.VisualControl, options?: PagingControlOptionsContract): PagingControl;
    /**
      ...
      * @param options  The initializition options.
      */
    function switchControl(idSuffix: string, parent?: Common.VisualControl, options?: SwitchControlOptionsContract): SwitchControl;
    /**
      ...
      * @param options  The initializition options.
      */
    function singleFlowControl<T>(idSuffix: string, parent?: Common.VisualControl, options?: SingleFlowControlOptionsContract<T>): SingleFlowControl<T>;
}
declare namespace AliHub.Common {
    /**
    ...
    class DateTime {
        ...
        /**
          ...
          */
        static toCustomizedString(value: Date, format: string, textFormat?: boolean): string;
        /**
        ...
        /**
          ...
          * @param value  The timespan in milliseconds.
          */
        static toSpanLocaleString(value: number | TimeSpanContract | AliHub.Common.Func<number> | AliHub.Common.Func<TimeSpanContract>, precision?: TimePrecisions): string;
        /**
          * Gets time string.
          * @param value  The date time.
          */
    ...
    class Stopwatch {
        ...
        /**
          ...
          */
        span(stop?: boolean): number;
        /**
          * Gets total timespan with rest in milliseconds.
          * @param stop  true if stops record; otherwise, false. Default is false.
          */
        spanWithRest(stop?: boolean): number;
        hasRecorded(): boolean;
        isRecording(): boolean;
    ...
    /**
      ...
      * @param options  The initializition options.
      */
    function calendarControl(idSuffix: string, parent?: VisualControl, options?: CalendarControlOptionsContract): CalendarControl;
    /**
      ...
      * @param options  The initializition options.
      */
    function timeControl(idSuffix: string, parent?: VisualControl, options?: TimeControlOptionsContract): TimeControl;
}
...
declare namespace AliHub.Elements {
    type AnyElementReference = string | HTMLElement | Window | Document | Common.VisualControl | Common.Func<string> | Common.Func<HTMLElement> | Common.Func<Window> | Common.Func<Document> | AliHub.Common.Func<Common.VisualControl>;
    ...
    interface SearchBarInfoContract {
        ...
        /**
          ...
          */
        suggest?: AliHub.Common.Func1<string, AliHub.Web.ResponseTask<any>>;
        /**
          * Action to enter.
          */
        enter?: AliHub.Common.Func1<string, AliHub.Web.ResponseTask<any>>;
        /**
    ...
    interface GestureActionOptionsContruct {
        /**
          ...
          */
        minX?: number | AliHub.Common.BindingObjectContract<number>;
        /**
          * The mininum vertical value to active related gesture handlers.
          */
        minY?: number | AliHub.Common.BindingObjectContract<number>;
        /**
          * The handler rasied on turning up. The element and distance will be provided.
          */
        turnUp?: AliHub.Common.Action2<HTMLElement | Window | Document, number>;
        /**
          * The handler rasied on turning right. The element and distance will be provided.
          */
        turnRight?: AliHub.Common.Action2<HTMLElement | Window | Document, number>;
        /**
          * The handler rasied on turning down. The element and distance will be provided.
          */
        turnDown?: AliHub.Common.Action2<HTMLElement | Window | Document, number>;
        /**
          * The handler rasied on turning left. The element and distance will be provided.
          */
        turnLeft?: AliHub.Common.Action2<HTMLElement | Window | Document, number>;
        /**
          * The handler rasied before moving. The element will be provided.
          */
        moveStart?: AliHub.Common.Action1<HTMLElement | Window | Document>;
        /**
          * The handler rasied after moving. The element and distance will be provided.
          */
        moveEnd?: AliHub.Common.Action2<HTMLElement | Window | Document, Common.PlaneCoordinate>;
        /**
          * The handler rasied on moving. The element and distance will be provided.
          */
        moving?: AliHub.Common.Action2<HTMLElement | Window | Document, Common.PlaneCoordinate>;
    }
    /**
    ...
    interface ScrollListenerOptionsContract {
        /**
          * Title owner.
          */
        titleOwner?: HTMLElement | string | Common.VisualControl | AliHub.Common.Func<HTMLElement> | AliHub.Common.Func<string> | AliHub.Common.Func<Common.VisualControl>;
        /**
          * Full title bar.
          */
        titleBar?: HTMLElement | string | Common.VisualControl | AliHub.Common.Func<HTMLElement> | AliHub.Common.Func<string> | AliHub.Common.Func<Common.VisualControl>;
        /**
          * Title bar after scrolling down.
          */
        titleShortBar?: HTMLElement | string | Common.VisualControl | AliHub.Common.Func<HTMLElement> | AliHub.Common.Func<string> | AliHub.Common.Func<Common.VisualControl>;
        /**
    ...
    /**
      ...
      */
    function register(name: string, control: typeof Common.VisualControl, h?: Common.Action1<any>): any;
    /**
      * Gets top offset of specific element in document.
      * @param element  the element.
      */
    function getTop(element: string | HTMLElement | Common.VisualControl | AliHub.Common.Func<HTMLElement> | AliHub.Common.Func<string> | AliHub.Common.Func<Common.VisualControl>): number;
    /**
      * Gets left offset of specific element in document.
      * @param element  the element.
      */
    function getLeft(element: string | HTMLElement | Common.VisualControl | AliHub.Common.Func<HTMLElement> | AliHub.Common.Func<string> | AliHub.Common.Func<Common.VisualControl>): number;
    /**
      * Gets the position of the specific element in document.
      * @param element  the element.
      */
    function getPosition(element: string | HTMLElement | Common.VisualControl | AliHub.Common.Func<HTMLElement> | AliHub.Common.Func<string> | AliHub.Common.Func<Common.VisualControl>): Common.PlaneCoordinate;
    /**
      * Gets the position of the mouse in specific element or document.
      * @param element  the optional element as target.
      */
    function getMousePosition(element?: string | HTMLElement | Common.VisualControl | AliHub.Common.Func<HTMLElement> | AliHub.Common.Func<string> | AliHub.Common.Func<Common.VisualControl>): Common.PlaneCoordinate;
    /**
    ...
    /**
      ...
      */
    function getQueryInfo(): Collection.StringPropertiesContract;
    /**
      * Gets query information object from URL.
      */
    function getQueryObj(): Collection.DictionaryContract<string>;
    /**
      * Gets query property by given name from URL.
      * @param name  the property name.
      */
    function getQuery(name: string | number): string;
    ...
    /**
      ...
      * @param element  the target element.
      */
    function getSize(element?: AnyElementReference, emptyForNull?: boolean): Common.PlaneCoordinate;
    /**
      * Adds a shortcut key for given element.
      * @param element  The target element.
      * @param options  The shortcut key options.
    ...
    /**
      * Search bar extender.
      */
    class SearchExtender implements AliHub.Common.BindingControlExtender<any> {
        private _info;
        /**
          * Extender name.
          */
        ...
        /**
          ...
          * @param control  The target control.
          */
        load(control: AliHub.Common.BindingControl<any>): void;
    }
}
...
declare namespace AliHub.Media {
    ...
    /**
      ...
      * @param options  The initializition options.
      */
    function audioControl(idSuffix: string, parent?: Common.VisualControl, options?: AudioControlOptionsContract): AudioControl;
    /**
      ...
      * @param options  The initializition options.
      */
    function cameraControl(idSuffix: string, parent?: Common.VisualControl, options?: CameraControlOptionsContract): CameraControl;
}
declare namespace AliHub.Common {
    /**
      * Page options.
...
declare namespace AliHub.Bindings {
    ...
    /**
      ...
      */
    function bindingProvider(value?: KnockoutStatic): KnockoutStatic;
    /**
    ...
    class KnockoutBindingFactory implements AliHub.Common.BindingFactoryContract {
        ...
        /**
          ...
          */
        createComputed<T>(h: AliHub.Common.Func<T>, context?: any): KnockoutComputed<T>;
        /**
    ...
    /**
      ...
      * https://angularjs.org/
      */
    function registerAngularJsControlController(angularInstance?: ng.IAngularStatic): ng.IModule;
    function angularScopeGet($scope: any, key: any, parameter: any, done: any, fail: any, target: any): Web.ResponseTask<{}>;
    function angularScopePost($scope: any, key: any, parameter: any, data: any, done: any, fail: any, target: any): Web.ResponseTask<{}>;
    /**
...
declare namespace AliHub.Res {
    ...
    /**
      ...
      * @param value  The optional value to set.
      */
    function settings(subject: string, key: string, value?: any): any;
    /**
      * Gets or sets HTML template.
      * @param subject  The subject name.
      * @param key  The template key.
...
declare namespace AliHub.Web {
    ...
    interface RestJobContract {
        ...
        /**
          ...
          */
        getString(template: string, parameters: any, canBeEmpty: boolean): Common.TaskContract<string>;
    }
    /**
    ...
    class RestJob implements Web.RestJobContract {
        ...
        /**
          * Sends by GET to resolve a string.
          */
        static getString(template: string, parameters: any, canBeEmpty?: boolean): Common.TaskContract<string>;
        /**
          * Sends by POST.
          */
        postInfo<T>(template: string, parameters: any, data: any, canBeEmpty?: boolean, validation?: (value: T) => boolean, convertor?: (value: T) => T): Common.TaskContract<T>;
        /**
          * Sends by POST.
          */
        postEmpty(template: string, parameters: any, data: any): Common.TaskContract<boolean>;
        /**
          * Sends by GET.
          */
        getInfo<T>(template: string, parameters: any, canBeEmpty?: boolean, validation?: (value: T) => boolean, convertor?: (value: T) => T): Common.TaskContract<T>;
        /**
          * Sends by GET.
          */
        getEmpty(template: string, parameters: any): Common.TaskContract<boolean>;
    ...
    class DataPackageJob implements Web.DataPackageJobContract {
        ...
        /**
          * Updgrade package.
          */
        static upgradePackage<T>(value: Web.PackageContract<T> | Web.ObsoletePackageContract<Web.ResponseContract<T>> | Web.ObsoletePackageContract<Web.EmptyResponseContract>): Web.PackageContract<T>;
        /**
          * Sends by POST.
          */
    ...
    /**
      ...
      */
    function resolver<T>(subject: string, key: string, value?: string | WebResolverInfoContract<T>): RequestDataPackageResolver<any, T>;
    /**
      * Creates resolvers.
      */
    ...
    /**
      ...
      */
    function resolve<T>(subject: string, key: string | Web.BaseDataPackageResolver<T>, parameters?: any): Web.ResponseTask<T>;
    /**
      * Resolves empty by GET.
      */
    function resolveEmpty(subject: string, key: string | Web.BaseDataPackageResolver<any>, parameters?: any): Web.EmptyResponseTask;
    /**
      * Resolves data by POST.
      */
    function resolveByPost<T>(subject: string, key: string | Web.BaseDataPackageResolver<T>, parameters?: any, data?: any): Web.ResponseTask<T>;
    /**
      * Resolves empty by POST.
      */
    function resolveEmptyByPost(subject: string, key: string | Web.BaseDataPackageResolver<any>, parameters?: any, data?: any): Web.EmptyResponseTask;
    /**
