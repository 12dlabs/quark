...
declare namespace AliHub.Common {
    ...
    class VisualControl {
        ...
        /**
          ...
          */
        appendElement<T extends Element>(child: T | string, idSuffix?: string): T;
        /**
...
declare namespace AliHub.Elements {
    ...
    interface HiddenFormContract extends Common.DisposableContract {
        ...
        fileField(key: string, change: boolean): PromiseLike<File>;
    ...
    /**
      ...
      * @param element  the element.
      */
    function getPosition(element: string | HTMLElement | Common.VisualControl | Common.Func<HTMLElement> | Common.Func<string> | Common.Func<Common.VisualControl>): Common.PlaneCoordinate;
    /**
      * Gets the position of the mouse in specific element or document.
      * @param element  the optional element as target.
      */
    function getMousePosition(element?: string | HTMLElement | Common.VisualControl | Common.Func<HTMLElement> | Common.Func<string> | Common.Func<Common.VisualControl>): Common.PlaneCoordinate;
    /**
