...
(function (AliHub) {
    ...
    (function (Runtime) {
        ...
        var KissyLoader = (function () {
            ...
            KissyLoader.moduleDebug = (typeof DEBUG !== "undefined" && DEBUG === true);
            KissyLoader.addModule = function (key, path, tag) {
                var now = new Date();
                var debugMode = KissyLoader.moduleDebug === true;
                var packageList = {};
                packageList[key] = {
                    path: path,
                    debug: debugMode,
                ...
                if (tag == null || tag === false) {
                    ...
                    packageList[key].tag = now.getTime().toString();
                } else {
                    packageList[key].tag = tag.toString();
                }
            ...
            KissyLoader.setup = function (corePath, bindingPath) {
                ...
                if (!!KISSY && !KissyLoader._getRequires && !!KISSY.Loader.Utils.getRequiresFromFn) {
                    KissyLoader._getRequires = KISSY.Loader.Utils.getRequiresFromFn;
                    KISSY.Loader.Utils.getRequiresFromFn = function (fn) {
            ...
            KissyLoader.enable = function (value) {
                if (value === false || value === 0 || value === "disable" || value === "f" || value === "F") {
                    ...
                    if (!!KISSY && !!KissyLoader._getRequires) KISSY.Loader.Utils.getRequiresFromFn = KissyLoader._getRequires;
                } else {
                    define = KissyLoader.regModule;
                }
            };
