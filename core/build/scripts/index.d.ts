...
declare namespace AliHub.Common {
    ...
    type ItemWithBoolean<T> = T | boolean | Func<T>;
    /**
    ...
    class VisualControl implements Common.DisposableContract {
        ...
        /**
          ...
          */
        nodeAppended: Collection.EventHandlers<Node[]>;
        /**
          * A disposable array which will be loaded during this instance is disposed.
          */
        disposableContainer: Collection.DisposableArray;
        /**
        ...
        propProp(name: string, propKey: string, includeInherit?: boolean): any;
        /**
        ...
        propInfo(name: string): {
            ...
            value: any;
            update: (v: any) => any;
            listen: (h: Common.Action1<Collection.ValueChangedContract<any>>) => void;
        };
        /**
          * Gets the specific additional property.
          * @param name  The property name.
        ...
        /**
          ...
          * @param includeInherit  true if include inherit properties; otherwise, false.
          */
        propObj(includeInherit?: boolean): any;
        /**
        ...
        /**
          ...
          */
        clearListenProp(key: string): void;
        /**
          * Gets the source control which has the property.
          * @param key  The property name.
          */
        getPropSourceControl(name: string): any;
        /**
        ...
        /**
          ...
          */
        pickStyleRef(key: string, candidates: any, ...childId: string[]): string[];
        /**
          * Adds style class.
        ...
        /**
          ...
          * @param removing  A list of style class to remove.
          */
        styleClass(adding?: string | string[], removing?: string | string[], ...childId: string[]): string[];
        /**
          * Sets style class from given candidates.
          * @param key  A key to select from the candidates.
          * @param candidates  A dictionary of candidates.
          */
        pickStyleClass(key: string, candidates: any, ...childId: string[]): string[];
        /**
          * Adds style class.
          * @param value  A list of style class to add.
          */
        addStyleClass(...value: string[]): string[];
        /**
          * Removes style class.
          * @param value  A list of style class to remove.
          */
        removeStyleClass(...value: string[]): string[];
        /**
        ...
        /**
          ...
          */
        grandParentControl<T extends VisualControl>(): T;
        /**
          * Gets parent element.
          */
        ...
        /**
          ...
          */
        appendElement<T extends Element>(child?: T | string, idSuffix?: string, styleRef?: string | string[], events?: any, attributes?: any): T;
        /**
          * Appends HTML as children.
          * @param html  An HTML string to append.
          */
        appendHTML(html: string): Node[];
        /**
          * Appends elements as child.
          * @param children  The element definitions to add.
          */
        appendElementByDef(...children: (Elements.SubElementDefinitionContract | string)[]): Element[];
        /**
          * Appends elements as child to a specific child.
          * @param idSuffix  The identifier suffix.
          * @param children  The element definitions to add.
          */
        appendElementByDefToChild(idSuffix: string, ...children: (Elements.SubElementDefinitionContract | string)[]): Element[];
        /**
        ...
        /**
          ...
          */
        addGesture(options: Elements.GestureActionOptionsContract, ...childId: string[]): void;
        /**
          * Adds gesture handlers to current control.
          * @param options  the options.
          */
    ...
    class ActivityControl extends VisualControl {
        ...
        /**
          ...
          */
        add(control?: Action1<HTMLElement>, model?: any, h?: Action1<VisualControl>): ControlInfoContract;
        /**
          * Gets item info.
    ...
    class ListenedBag {
        private _model;
        changed: Collection.EventHandlers<Collection.ValueChangedContract<any>>;
        prop(key: string, value?: any): any;
        listenedProp<T>(key: string, createOneWhenEmpty?: boolean): ListenedObjectContract<T>;
        loadModel(bag: any): number;
        getModel(): any;
        hasProp(key: string): (h: (ev: ValueChangedArgsContract<any>) => void, target?: any, disposableList?: Collection.DisposableArray, args?: any, remove?: Func3<ValueChangedArgsContract<any>, any, number, boolean>) => DisposableContract;
        removeProp(...key: string[]): number;
    }
    /**
    ...
    function sleepLoop(h: AliHub.Common.Func<boolean>, timeout: number, count?: number): {
        dispose: () => void;
        times: () => any;
        timeout: (value?: number) => any;
        count: (value?: number) => any;
        handler: () => Func<boolean>;
    };
    /**
    ...
    /**
      ...
      * @param value  The value if need fill initially.
      */
    function listenedObj<T>(initValue?: T): ListenedObjectContract<T>;
...
declare namespace AliHub.Collection {
    ...
    class SwitchControl extends Common.VisualControl {
        ...
        /**
          ...
          */
        add(control?: Common.Action1<HTMLElement>, model?: any, options?: SwitchItemOptionsContract): Common.VisualControl;
    ...
    class EventHandlers<T> {
        ...
        /**
          ...
          */
        add(h: Common.EventHandler<T>, target?: any, disposableList?: DisposableArray, args?: any, remove?: Common.Func3<T, any, number, boolean>, delay?: boolean | number): {
            added: Date;
            hasAdded: boolean;
            dispose: () => void;
            raise: (ev: T) => void;
        ...
        addOnce(h: Common.EventHandler<T>, target?: any, disposableList?: DisposableArray, args?: any, delay?: boolean | number): {
            added: Date;
            hasAdded: boolean;
            dispose: () => void;
            raise: (ev: T) => void;
        ...
        /**
          ...
          */
        raise(ev: T, ignoreEx?: boolean, delay?: boolean | number): void;
        /**
    ...
    class Mapping<T> {
        ...
        changed: EventHandlers<ValueChangedContract<T>>;
        get(key: string): T;
        /**
          * Sets up a mapping.
          */
        map(dict: Collection.DictionaryContract<T>, clearBeforeSet?: boolean): void;
        push(key: string, value: T): void;
        item(key: string, value?: T): T;
    ...
    /**
      ...
      */
    function copy<T>(list: T[], removeEmpty?: boolean): T[];
    /**
    ...
    /**
      ...
      */
    function addItem(raw: string, split: string, addingItems: string | string[], removingItems?: string | string[], keepSplitAround?: boolean): string;
    /**
      * Gets an entry.
    ...
    /**
      ...
      */
    function formatList<T>(col: T[], format: AliHub.Common.Func1<T, T>, removeEmpty?: boolean): T[];
    /**
...
declare namespace AliHub.Diagnostics {
    ...
    interface TrackerContract {
        /**
          * Logs something.
          */
        log(type: LogTypes, category: string, message: string, ...optionalParams: any[]): any;
    }
    /**
    ...
    class Tracker implements TrackerContract, PageAnalyticsClientContract {
        ...
        /**
          ...
          */
        log(type: LogTypes, category: string, message: string, ...optionalParams: any[]): void;
        /**
          * Logs a message as INFO level.
          */
        info(category: string, message: string, ...optionalParams: any[]): void;
        /**
          * Logs a message for debug.
          */
        debug(category: string, message: string, ...optionalParams: any[]): void;
        /**
          * Logs a message as WARN level.
          */
        warn(category: string, message: string, ...optionalParams: any[]): void;
        /**
          * Logs a message as ERROR level.
          */
        error(category: string, message: string, ...optionalParams: any[]): void;
    }
    ...
    /**
      * Logs a message as INFO level.
      */
    function info(category: string, message: string, ...optionalParams: any[]): void;
    /**
      * Logs a message for debug.
      */
    function debug(category: string, message: string, ...optionalParams: any[]): void;
    /**
      * Logs a message as WARN level.
      */
    function warn(category: string, message: string, ...optionalParams: any[]): void;
    /**
      * Logs a message as ERROR level.
      */
    function error(category: string, message: string, ...optionalParams: any[]): void;
    /**
      * Logs a message as a specific level.
      */
    function log(type: LogTypes, category: string, message: string, ...optionalParams: any[]): void;
    /**
      * Records with an identifier for mark.
      */
...
declare namespace AliHub.Elements {
    ...
    type PeripheralPopupControl = Common.VisualControl & {
        target(): HTMLElement;
    ...
    interface SubElementDefinitionContract {
        ...
        innerHTML?: string | number | {
            encode?: boolean | Common.Func1<string, string>;
    ...
    interface SimpleElementDefinitionContract {
        tagName?: string;
        styleRef?: string[];
        attr?: any;
        style?: any;
    ...
    interface CheckboxControlOptionsContract extends AliHub.Common.VisualControlOptionsContract<CheckboxControl> {
        name?: string;
        model?: any;
        select?: boolean;
    ...
    function openPage(url: string, target?: string, data?: any): void;
    /**
    ...
    /**
      ...
      */
    function getMousePosition(element?: string | HTMLElement | Common.VisualControl | Common.Func<HTMLElement> | Common.Func<string> | Common.Func<Common.VisualControl>, ev?: MouseEvent): Common.PlaneCoordinate & Common.InvalidContract;
    /**
    ...
    /**
      ...
      */
    function inElement(test: AnyElementReference, container: AnyElementReference): boolean;
    /**
      ...
      */
    function createChildren(container: HTMLElement, ...children: (SimpleElementDefinitionContract | string)[]): Element[];
    /**
      ...
      */
    function childNodes(element: Element | Element[], ...tagName: (string | string[])[]): Element[];
    /**
      ...
      */
    function changeStyleRef(element: HTMLElement | string, adding?: string | string[], removing?: string | string[], reverse?: boolean): string[];
    /**
      * Adds style references and resolves the list all.
      * @param element  the element.
      * @param adding  the names to add.
      */
    function addStyleRef(element: HTMLElement | string, ...adding: string[]): string[];
    /**
      * Removes style references and resolves the list all.
      * @param element  the element.
      * @param removing  the names to remove.
      */
    function removeStyleRef(element: HTMLElement | string, ...removing: string[]): string[];
    /**
      * Changes style references and resolves the list all.
      * @param element  the element.
      * @param adding  the names to add.
      * @param removing  the names to remove.
      */
    function changeStyleClass(element: HTMLElement | string, adding?: string | string[], removing?: string | string[], reverse?: boolean): string[];
    /**
      * Adds style references and resolves the list all.
      * @param element  the element.
      * @param adding  the names to add.
      */
    function addStyleClass(element: HTMLElement | string, ...adding: string[]): string[];
    /**
      * Removes style references and resolves the list all.
      * @param element  the element.
      * @param removing  the names to remove.
      */
    function removeStyleClass(element: HTMLElement | string, ...removing: string[]): string[];
    /**
    ...
    /**
      ...
      */
    function getPageAddress(includePort?: boolean): string;
    /**
      * Requests full screen.
      */
    ...
    /**
      ...
      * @param h  the event handler to add.
      */
    function listenOnceLater(element: EventElementReferences, eventType: string, ...h: ((ev: Event) => void)[]): PromiseLike<Common.DisposableContract>;
    /**
      * Adds an event listener to a target element.
      * @param element  the target element.
      * @param eventType  the type of event.
    ...
    /**
      ...
      * @param options  the options.
      */
    function addGesture(element: AnyElementReference, options: GestureActionOptionsContract): Common.DisposableContract;
    /**
    ...
    /**
      ...
      * @param name  the attribute name to test one by one.
       * @param value  the value to set.
     */
    function setAttr(element: AnyElementReference, name: string, value: any): string;
    /**
    ...
    /**
      ...
      */
    function popup(model: PeripheralPopupContract): PeripheralPopupControl;
    ...
    class ButtonControl extends Common.VisualControl {
        /**
    ...
    /**
      ...
      */
    class CheckboxControl extends Common.VisualControl {
        name: Common.ListenedObjectContract<string>;
        selected: Common.ListenedObjectContract<boolean>;
        nameIsHTML: Common.ListenedObjectContract<boolean>;
        model: Common.ListenedObjectContract<any>;
        getGroup: Common.Func<(CheckboxControl | HTMLElement | string)[]>;
        unselectOthers: Common.ListenedObjectContract<boolean>;
        disableSelectByUI: Common.ListenedObjectContract<boolean>;
        checkboxIcon: Common.ListenedObjectContract<Graph.ImageContract>;
        radioIcon: Common.ListenedObjectContract<Graph.ImageContract>;
        /**
        ...
        /**
          ...
          * @param options  The options to load.
          */
        loadOptions(value: CheckboxControlOptionsContract | boolean | Common.Func<CheckboxControlOptionsContract>): any;
        refreshName(): string;
        forEachControl(callbackfn: (value: CheckboxControl, index: number, array: CheckboxControl[]) => void, thisArg?: any): number;
        getSelectedModels(): any[];
        getSelectedControls(): CheckboxControl[];
        setGroupControls(...col: CheckboxControl[][]): number;
    }
    /**
...
declare namespace AliHub.Media {
    ...
    function speak(sentence: any): any;
    /**
...
declare namespace AliHub.Res {
    ...
    class Templates {
        ...
        /**
          ...
          * @param value  The optional value to set.
          */
        settingsProp<T>(key: string, prop: string, value?: T): T;
        /**
        ...
        /**
          ...
          */
        svgImage(key: string, styleRef?: string | string[]): Graph.SvgImageContract;
        /**
          * Gets SVG element from templates.
          * @param key  The template key.
          * @param styleRef  The optional style references.
          */
        svgElement(key: string, styleRef?: string | string[]): SVGElement;
        /**
          * Gets local string.
          * @param key  The template key.
        ...
        /**
          ...
          * @param lang  The opitonal market code string for a sepecific one.
          */
        localStringInHTML(key: string, lang?: string): string;
    }
    /**
      * String set.
      */
    class Strings {
        ...
        /**
          ...
          * @param lang  The opitonal market code string for a sepecific one.
          */
        fieldInHTML(key: string, lang?: string): string;
        toJSON(): string;
    ...
    /**
      ...
      * @param value  The optional value to set.
      */
    function settingsProp<T>(subject: string, key: string, prop: string, value?: T): T;
    /**
      * Gets or sets HTML template.
      * @param subject  The subject name.
      * @param key  The template key.
    ...
    /**
      ...
      * @param styleRef  The optional style references.
      */
    function svgImage(subject: string, key: string, styleRef?: string | string[]): Graph.SvgImageContract;
    /**
      * Gets SVG element from templates.
      * @param subject  The subject name.
      * @param key  The template key.
      * @param styleRef  The optional style references.
      */
    function svgElement(subject: string, key: string, styleRef?: string | string[]): SVGElement;
...
declare namespace AliHub.Users {
    ...
    function session<T>(key: string, value?: T): T;
    function fillSession<T>(obj: any, ignoreIfExist?: boolean): string[];
    /**
      * Profile card.
      */
...
declare namespace AliHub.Common {
    ...
    class Text {
        ...
        /**
          ...
          */
        static serialize(obj: any, onlyJson?: boolean | "simple" | "string" | "full"): string;
        /**
          * Returns the position of the first occurrence of a substring.
        ...
        static inScope(str: string, left: string, right: string, ignorePrefix?: string): string[];
        static isString(value: any): value is string;
        static isNotEmptyString(value: any): value is string;
        static isEmptyOrWhiteSpace(value: any): value is string;
...
declare namespace AliHub.Web {
    ...
    class RestJob implements Web.RestJobContract {
        ...
        /**
          ...
          */
        getString(template: string, parameters: any, canBeEmpty?: boolean): PromiseLike<string>;
        private _jQueryAjax<T>(deferred, path, method, data, cors, canBeEmpty, validation, convertor);
        private _fetchResp<T>(deferred, path, method, data, cors, canBeEmpty, validation, convertor);
    }
    /**
    ...
    /**
      ...
      */
    function mergeLink(link: string, data: any, justAppend?: boolean): string;
    /**
    ...
    /**
      ...
      */
    function buildParaString(parameters: any, onlySimple?: boolean): string;
}
declare namespace AliHub.Bindings {
    ...
    /**
      ...
      * http://jquery.com/
      */
    function jQueryControlsSetup(): void;
    /**
    ...
    class GoldlogTracker implements AliHub.Diagnostics.PageAnalyticsClientContract {
        ...
        mapping: Collection.Mapping<string[]>;
        ignoreCustomizedParameter: boolean;
        /**
          * Records a stamp.
          */
