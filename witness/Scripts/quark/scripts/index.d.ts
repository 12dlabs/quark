...
declare namespace AliHub.Elements {
    ...
    /**
      ...
      */
    function getQueryInfo(url?: string, emptyStringForNull?: boolean): Collection.StringPropertiesContract;
    /**
      * Gets query information object from URL.
      */
    function getQueryObj(url?: string, emptyStringForNull?: boolean): Collection.DictionaryContract<string>;
    /**
    ...
    /**
      ...
      * @param name  the property name.
      */
    function getStringQuery(url: string, name: string | number): string;
    ...
    /**
      ...
      */
    function processAll(container: HTMLElement | Document | Window | string, h: (element: Element) => void): void;
